    ...
    <div class="wrapper">
        ...
        <?php 
            if(isset($_GET['id']))
            {
                ...
                if($count==1)
                {
                    ...
                    $driver_id = $row['driver_id']; // This might be NULL or 0
                }
                else
                {
                ...
                <tr>
                    ...
                    <td>
                        <select name="driver_id">
                            ...
                            <?php 
                                // Restaurants can see all drivers for now
        ...
        <?php 
            if(isset($_POST['submit']))
            {
                ...
                if($res2==true)
                {
                    $_SESSION['update'] = "<div class='success'>Driver Assigned Successfully.</div>";
                    header('location:'.SITEURL.'restaurant/manage-order.php');
                }
                else
                {
